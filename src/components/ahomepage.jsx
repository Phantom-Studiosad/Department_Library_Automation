...
function AHomepage(){
   ...
   const  constructor = () =>{
        ...
        setRoll(userEmail.substring(3,10));
        if (user !== null) {
                  ...
                  <div class="container"> 
                          <div class="homepage_container">     
                                    <div class="w3-row">
                                                            ...
                                                            <div class="pop_card box">
                                                                <div class="login-container1 animated flipInX main-heading">
                                                                    ...
                                                                    <form class="margin-t">
                                                                        ...
                                                                        <div class="text-c">
                                                                            <button type="button" class="btn navbar-btn loginp1 margin-b"><span class="fa fa-code-fork" onClick={borrowBook}></span> Borrow</button>                                                                                   
                                                                        </div>                                            
                                                                    </form>
                                                                </div>                                                            
                                                            </div>
                                        ...
                                        <div class="w3-col m3">
                                            <div class="w3-card w3-round homepage_bg" style={{textAlign:"center"}}>
                                            <h4 class="w3-center">Pending Due's</h4>
                                            <hr></hr>
                                                <div class="hp_profile">
